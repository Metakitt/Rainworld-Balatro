...
use = function(self, card, area, copier)
	...
	_rank = pseudorandom_element({'A','J', 'Q', 'K', '2', '3', '4', '5', '6', '7', '8', '9', 'T'}, pseudoseed('test'))
    _suit = pseudorandom_element({'S','H','D','C'}, pseudoseed('test'))
	G.deck.config.card_limit = G.deck.config.card_limit + 1
	local other_card = create_playing_card({front = G.P_CARDS[_suit..'_'.._rank], center = G.P_CENTERS.c_base}, G.hand, nil, nil, {G.C.SECONDARY_SET.Enhanced})
