...
SMODS.Joker({
	...
	attributes = { "enemy", "joker", "rot", "modify_card", "mult", "chance", "ante" },
	...
	calculate = function(self, card, context)
		...
		if context.joker_main and not context.blueprint then
			...
			for i = 1, #G.jokers.cards do
				if SMODS.pseudorandom_probability(card, "rw_hunterlonglegs", 1, card.ability.extra.odds, "rw_hunterlonglegs") and not context.blueprint then
