...
unlocked = true,
discovered = true,
config = { extra = { center_table = 1, odds = 10, mult = 0, mult_gain = 8, spear = false}, slugcat = true},
...
calculate = function(self, card, context)	
	...
	if context.setting_blind and pseudorandom('hunterhell') < G.GAME.probabilities.normal / card.ability.extra.odds and G.GAME.round_resets.blind_ante < 8 and not context.blueprint then
