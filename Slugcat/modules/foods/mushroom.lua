...
use = function(self,card,area,copier)
	...
	if card.ability.name == 'mushroom' and card.area == G.consumeables and card.area ~= G.pack_cards and card.ability.extra.pack == false then
	if pseudorandom('mushroom') < G.GAME.probabilities.normal / card.ability.extra.odds and G.GAME.blind.in_blind then
