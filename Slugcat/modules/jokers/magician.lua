...
config = { extra = { effect = 'none', x_chips = 1, chips = 0, x_mult = 1, mult = 0, should_score = false, h_size = 0, type = "Flush", wepodds = 15, mushodds = 10, munch = false, saintodds = 20, food = 'none', hand_type = 'none' }, slugcat = true},
	
loc_vars = function(self, info_queue, card)
 if card.ability.extra.effect == 'none' then
 return { vars = {(G.GAME.probabilities.normal or 1), card.ability.extra.effect, card.ability.extra.chips, card.ability.extra.x_mult, card.ability.extra.mult, card.ability.extra.x_chips }, key = self.key..'' }
 end
 
 if card.ability.extra.effect == 'artificer' then
    return { vars = {(G.GAME.probabilities.normal or 1), card.ability.extra.effect, card.ability.extra.chips, card.ability.extra.x_mult, card.ability.extra.mult, card.ability.extra.x_chips }, key = self.key..'_artificer' }
    end

    if card.ability.extra.effect == 'bng' then
  return { vars = {(G.GAME.probabilities.normal or 1), card.ability.extra.effect, card.ability.extra.chips, card.ability.extra.x_mult, card.ability.extra.mult, card.ability.extra.x_chips }, key = self.key..'_bng' }
    end
	
	 if card.ability.extra.effect == 'hunter' then
  return { vars = {(G.GAME.probabilities.normal or 1), card.ability.extra.effect, card.ability.extra.chips, card.ability.extra.x_mult, card.ability.extra.mult, card.ability.extra.x_chips }, key = self.key..'_hunter' }
    end
	
	if card.ability.extra.effect == 'inv' then
  return { vars = {(G.GAME.probabilities.normal or 1), card.ability.extra.effect, card.ability.extra.chips, card.ability.extra.x_mult, card.ability.extra.mult, card.ability.extra.x_chips }, key = self.key..'_inv' }
    end
	
	if card.ability.extra.effect == 'monk' then
  return { vars = {(G.GAME.probabilities.normal or 1), card.ability.extra.effect, card.ability.extra.chips, card.ability.extra.x_mult, card.ability.extra.mult, card.ability.extra.x_chips }, key = self.key..'_monk' }
    end
	
		if card.ability.extra.effect == 'scugbo' then
  return { vars = {(G.GAME.probabilities.normal or 1), card.ability.extra.effect, card.ability.extra.chips, card.ability.extra.x_mult, card.ability.extra.mult, card.ability.extra.x_chips }, key = self.key..'_scugbo' }
    end
	
		if card.ability.extra.effect == 'slugpup' then
  return { vars = {(G.GAME.probabilities.normal or 1), card.ability.extra.effect, card.ability.extra.chips, card.ability.extra.x_mult, card.ability.extra.mult, card.ability.extra.x_chips }, key = self.key..'_slugpup' }
    end
	
	if card.ability.extra.effect == 'gourmand' then
  return { vars = {(G.GAME.probabilities.normal or 1), card.ability.extra.effect, card.ability.extra.chips, card.ability.extra.x_mult, card.ability.extra.mult, card.ability.extra.x_chips }, key = self.key..'_gourmand' }
    end
	
	if card.ability.extra.effect == 'rivulet' then
  return { vars = {(G.GAME.probabilities.normal or 1), card.ability.extra.effect, card.ability.extra.chips, card.ability.extra.x_mult, card.ability.extra.mult, card.ability.extra.x_chips }, key = self.key..'_rivulet' }
    end
	
	if card.ability.extra.effect == 'spearmaster' then
  return { vars = {(G.GAME.probabilities.normal or 1), card.ability.extra.effect, card.ability.extra.chips, card.ability.extra.x_mult, card.ability.extra.mult, card.ability.extra.x_chips }, key = self.key..'_spearmaster' }
    end
	
	if card.ability.extra.effect == 'survivor' then
  return { vars = {(G.GAME.probabilities.normal or 1), card.ability.extra.effect, card.ability.extra.chips, card.ability.extra.x_mult, card.ability.extra.mult, card.ability.extra.x_chips }, key = self.key..'_survivor' }
    end
	
		if card.ability.extra.effect == 'pathfinder' then
  return { vars = {(G.GAME.probabilities.normal or 1), card.ability.extra.effect, card.ability.extra.chips, card.ability.extra.x_mult, card.ability.extra.mult, card.ability.extra.x_chips }, key = self.key..'_pathfinder' }
    end
	
		if card.ability.extra.effect == 'blurred' then
  return { vars = {(G.GAME.probabilities.normal or 1), card.ability.extra.effect, card.ability.extra.chips, card.ability.extra.x_mult, card.ability.extra.mult, card.ability.extra.x_chips }, key = self.key..'_blurred' }
    end
	
		if card.ability.extra.effect == 'alacrity' then
  return { vars = {(G.GAME.probabilities.normal or 1), card.ability.extra.effect, card.ability.extra.chips, card.ability.extra.x_mult, card.ability.extra.mult, card.ability.extra.x_chips }, key = self.key..'_alacrity' }
    end
	
		if card.ability.extra.effect == 'magician' then
  return { vars = {(G.GAME.probabilities.normal or 1), card.ability.extra.effect, card.ability.extra.chips, card.ability.extra.x_mult, card.ability.extra.mult, card.ability.extra.x_chips }, key = self.key..'_magician' }
    end
	
	if card.ability.extra.effect == 'enfys' then
  return { vars = {(G.GAME.probabilities.normal or 1), card.ability.extra.effect, card.ability.extra.chips, card.ability.extra.x_mult, card.ability.extra.mult, card.ability.extra.x_chips }, key = self.key..'_enfys' }
    end
	
	if card.ability.extra.effect == 'saint' then
  return { vars = {(G.GAME.probabilities.normal or 1), card.ability.extra.effect, card.ability.extra.chips, card.ability.extra.x_mult, card.ability.extra.mult, card.ability.extra.x_chips }, key = self.key..'_saint' }
    end
	
	if card.ability.extra.effect == 'lacuna' then
  return { vars = {(G.GAME.probabilities.normal or 1), card.ability.extra.effect, card.ability.extra.chips, card.ability.extra.x_mult, card.ability.extra.mult, card.ability.extra.x_chips }, key = self.key..'_lacuna' }
    end
	
	if card.ability.extra.effect == 'ranger' then
  return { vars = {(G.GAME.probabilities.normal or 1), card.ability.extra.effect, card.ability.extra.chips, card.ability.extra.x_mult, card.ability.extra.mult, card.ability.extra.x_chips }, key = self.key..'_ranger' }
    end
	
	end,
add_to_deck = function(self, card, from_debuff) 
   card.ability.extra.effect = pseudorandom_element({'artificer', 'bng', 'hunter', 'inv', 'monk', 'rivulet', 'slugpup', 'spearmaster', 'survivor', 'scugbo', 'blurred', 'pathfinder', 'gourmand', 'alacrity', 'magician', 'saint', 'enfys', 'lacuna', 'ranger'}, pseudoseed('slugcats'))
    end,
...
mult = card.ability.extra.mult
	...
	destructable_cards[#destructable_cards+1] = G.hand.cards[i] end
    end
    local card_to_destroy = #destructable_cards > 0 and pseudorandom_element(destructable_cards, pseudoseed('explode')) or nil
...
-- Rivulet (Skipping blind resets the ability).
	...
	_rank = pseudorandom_element({'A','J', 'Q', 'K', '2', '3', '4', '5', '6', '7', '8', '9', 'T'}, pseudoseed('rivuletrank'))
    _suit = pseudorandom_element({'S','H','D','C'}, pseudoseed('rivuletsuit'))
	 local card = create_playing_card({front = G.P_CARDS[_suit..'_'.._rank], center = pseudorandom_element(G.P_CENTER_POOLS["Enhanced"], pseudoseed('rivuletscard'))}, G.deck, nil, nil, {G.C.SECONDARY_SET.Enhanced})
	 local card = create_playing_card({front = G.P_CARDS[_suit..'_'.._rank], center = pseudorandom_element(G.P_CENTER_POOLS["Enhanced"], pseudoseed('rivuletscard'))}, G.deck, nil, nil, {G.C.SECONDARY_SET.Enhanced})
	 local card = create_playing_card({front = G.P_CARDS[_suit..'_'.._rank], center = pseudorandom_element(G.P_CENTER_POOLS["Enhanced"], pseudoseed('rivuletscard'))}, G.deck, nil, nil, {G.C.SECONDARY_SET.Enhanced})
	 blind_skipped = true
	end
...
if context.pre_discard and pseudorandom('upgrade') < G.GAME.probabilities.normal / card.ability.extra.saintodds then
...
if context.pre_discard and G.consumeables.config.card_limit ~= #G.consumeables.cards and not context.blueprint then	
...
local consume = G.consumeables.cards[1]
    ...
    mult = card.ability.extra.mult
            ...
            if consume.ability.set == 'Planet' and pseudorandom('randomlevel') < G.GAME.probabilities.normal / card.ability.extra.odds then
			
			--print ('levelupplanet')
		card.ability.extra.hand_type = pseudorandom_element({'Flush', 'Pair', 'High Card', 'Three of a Kind', 'Full House', 'Four of a Kind', 'Flush', 'Straight', 'Two Pair', 'Straight Flush'}, pseudoseed('levelup'))
        update_hand_text({sound = 'button', volume = 0.7, pitch = 0.8, delay = 0.3}, {handname=localize(card.ability.extra.hand_type, 'poker_hands'),chips = G.GAME.hands[card.ability.extra.hand_type].chips, mult = G.GAME.hands[card.ability.extra.hand_type].mult, level=G.GAME.hands[card.ability.extra.hand_type].level})
        ...
        update_hand_text({sound = 'button', volume = 0.7, pitch = 1.1, delay = 0}, {mult = 0, chips = 0, handname = '', level = ''})
			...
			if consume.ability.set == 'Tarot' and context.main_eval and G.consumeables.config.card_limit > #G.consumeables.cards then
			--print ('tarot')
			 local n_card = SMODS.create_card({set = "Tarot", area = G.consumeables})
             G.consumeables:emplace(n_card)
			end
	...
	local seal_type = pseudorandom(pseudoseed('certsl'))
                        if seal_type > 0.75 then chosen_card:set_seal('Red', true)
                        elseif seal_type > 0.5 then chosen_card:set_seal('Blue', true)
                        elseif seal_type > 0.25 then chosen_card:set_seal('Gold', true)
                        else chosen_card:set_seal('Purple', true)
                        end
...
if consume.ability.set == 'foods' and pseudorandom('upgrade') < G.GAME.probabilities.normal / card.ability.extra.odds then
local buffup = {}
for i = 1, #G.hand.cards do
...
SMODS.calculate_effect({message = localize('k_upgrade_ex'), colour = G.C.CHIPS}, buffup)
			...
			if consume.ability.set == 'obtainweapon' and pseudorandom('upgrade') < G.GAME.probabilities.normal / card.ability.extra.oddswep then
			--print ('disaster')
	...
	local weapon = pseudorandom_element({'rw_wbeehive','rw_wcherrybomb','rw_wspear','rw_wspear_ele','rw_wspear_exp','rw_wspear_fire','rw_wflashbang','rw_wgrenade','rw_wjokerifle','rw_wrock','rw_wsingularity', 'rw_wsporepuff'}, pseudoseed('levelup'))
...
if context.setting_blind then
card.ability.extra.food = pseudorandom_element({'j_popcorn','j_gros_michel','j_ice_cream','j_egg','j_flower_pot','j_ramen','j_diet_cola','j_turtle_bean'}, pseudoseed('foods'))
