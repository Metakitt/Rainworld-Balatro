...
SMODS.Joker({
	...
	config = { extra = { center_table = 1, defeat = false, odds = 8, antimult = 0, enemy_type = "none", amount = 0, condition = "none", condition_req = 0, edition_condition = "e_base" }, enemy = true },
