...
calculate = function(self, card, context)
    if context.setting_blind and context.main_eval and G.jokers.config.card_limit <= #G.jokers.cards and G.consumeables.config.card_limit > #G.consumeables.cards then
