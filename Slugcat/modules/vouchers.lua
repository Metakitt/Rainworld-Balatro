...
if G.GAME.last_blind.boss and context.end_of_round and context.main_eval and pseudorandom('weapon') < G.GAME.probabilities.normal / card.ability.extra.odds then
local cr = math.random(1,11)
local weaponselected = 'none'
if cr <= 5 then
weaponselected = pseudorandom_element({'bluefruit', 'spear', 'rock', 'cherrybomb', 'grenade', 'pearl'}, pseudoseed('common'))
elseif cr > 5 and cr <= 9 then
weaponselected = pseudorandom_element({'electricspear', 'explosivespear', 'beehive', 'flashbang', 'sporepuff'}, pseudoseed('uncommon'))
elseif cr > 9 then
