...
--Undefeated
	if context.main_eval and context.end_of_round and G.GAME.round_resets.blind_ante ~= 8 and G.GAME.blind.boss and card.ability.extra.defeat == false and not context.blueprint then
