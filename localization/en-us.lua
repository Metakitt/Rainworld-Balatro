...
return {
		...
		Joker = {
			...
			j_rw_leviathan = {
				...
				text = {
					...
					"{C:red}Cannot be Defeated:{} Leaves on Ante 9+.",
					"{C:attention}Undefeated: {C:red}Die{}.",
				},
			},
			j_rw_redcentipede = {
	...
	misc = {
		...
		achievement_names = {
			...
			ach_rw_passage_monk = "The Monk",
			ach_rw_passage_hunter = "The Hunter",
			ach_rw_passage_saint = "The Saint",
			ach_rw_passage_outlaw = "The Outlaw",
			ach_rw_passage_chieftain = "The Chieftain",
			ach_rw_passage_wanderer = "The Wanderer",
			ach_rw_passage_dragonslayer = "The Dragon Slayer",
			ach_rw_passage_friend = "The Friend",
			ach_rw_passage_scholar = "The Scholar",
			ach_rw_passage_martyr = "The Martyr",
			ach_rw_passage_nomad = "The Nomad",
			ach_rw_passage_pilgrim = "The Pilgrim",
		...
		achievement_descriptions = {
			...
			ach_rw_passage_friend = "(Unimplemented)",
			ach_rw_passage_scholar = "(Unimplemented)",
			ach_rw_passage_martyr = { "Win a run without ever", "using a Food card" },
			ach_rw_passage_nomad = "(Unimplemented)",
