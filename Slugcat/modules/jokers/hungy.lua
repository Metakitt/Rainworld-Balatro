SMODS.Joker {
    ...
    update = function(self, card, dt)
        if card.ability.extra.grace > 0 then card.ability.extra.grace = card.ability.extra.grace - dt end
        
        if #SMODS.find_card("j_rw_hunger") > 0 -- Make sure to replace this with the actual key
        and card.ability.extra.grace <= 0
        and card.ability.extra.can_munch
        and (pseudorandom(pseudoseed('crumchy')) < G.GAME.probabilities.normal / card.ability.extra.munch_chance) then
