-- TODO: Use xmult, xchips attributes
local x_mult_chips_jokers_keys = {
	"j_joker_stencil",
	"j_steel_joker",
	"j_black_board",
	"j_constellation",
...
SMODS.Joker({
	...
	attributes = { "enemy", "xmult", "xchips", "destroy_card", "weapon" },
