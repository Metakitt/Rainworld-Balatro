...
SMODS.Joker({
	...
	attributes = { "enemy", "chance", "rot", "modify_card", "suit" },
	loc_vars = function(self, info_queue, card)
		...
		return { vars = { SMODS.get_probability_vars(card, 1, card.ability.extra.odds, "rw_motherlonglegs") } }
	end,
	...
	calculate = function(self, card, context)
		...
		then
			...
			if chosen_card ~= nil and not chosen_card.getting_sliced and not context.blueprint then
