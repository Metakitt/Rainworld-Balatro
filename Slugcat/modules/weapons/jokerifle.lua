...
local chosen_cards = G.deck.cards[i]
	...
	if chosen_cards:is_suit("Hearts") or chosen_cards:is_suit("Spades") or chosen_cards:is_suit("Diamonds") then
 ...
 if suit.key == "Hearts" then
	if chosen_cards:is_suit("Clubs") or chosen_cards:is_suit("Spades") or chosen_cards:is_suit("Diamonds") then
	SMODS.debuff_card(chosen_cards,true,'bees')
	end
 ...
 if suit.key == "Diamonds" then
	if chosen_cards:is_suit("Hearts") or chosen_cards:is_suit("Spades") or chosen_cards:is_suit("Clubs") then
	SMODS.debuff_card(chosen_cards,true,'bees')
	end
 ...
 if suit.key == "Spades" then
	if chosen_cards:is_suit("Hearts") or chosen_cards:is_suit("Clubs") or chosen_cards:is_suit("Diamonds") then
	SMODS.debuff_card(chosen_cards,true,'bees')
	end
...
loc_vars = function(self, info_queue, card)
        info_queue[#info_queue+1] = { set = 'Other', key = 'rw_wjokerifle'}
		end,
...
SMODS.Stickers["rw_wjokerifle"]:apply(v,true)
	end
	end
	end
	}