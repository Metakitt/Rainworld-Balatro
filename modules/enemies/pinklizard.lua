SMODS.Joker({
	...
	config = { extra = { defeat = false, card_odds = 2, deck_odds = 20, enemy_type = "none", amount = 0, condition = "none", condition_req = 0, edition_condition = "e_base" }, enemy = true },
	...
	loc_vars = function(self, info_queue, card)
		return {
			vars = { card.ability.extra.card_odds, card.ability.extra.deck_odds },
		}
	end,
