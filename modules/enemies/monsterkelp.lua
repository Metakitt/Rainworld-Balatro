...
config = { extra = {defeat = false, dying = false, unchips = -60, card_unchips = -10, enemy_type = "none", amount = 0, condition = "none", condition_req = 0, edition_condition = "e_base"}, enemy = true},
